    ...
    render() {
        ...
        <div class="glass-pane border-b border-white/5 pt-12 pb-3 px-4 sticky top-0 z-20  bg-[#1a1b22]/90">
            <div class="flex justify-between items-center mb-3">
                <div>
                    <h1 class="text-2xl md:text-3xl font-black chrome-text">NanzMusify</h1>
        ...
        if (S.hc && S.hc.length > 0) {
            songsHtml = S.hc.map(function(t, i) {
                ...
                return '<div onclick="PK(\'homecat\','+i+')" class="snap-start home-cat-card group '+cardBg+' rounded-xl flex items-center gap-2.5 p-2 cursor-pointer active:scale-95 transition-all w-full">'+
                    '<img src="'+t.cover+'" class="w-11 h-11 rounded-lg object-cover shadow-md shrink-0 bg-[#1e202e]" referrerPolicy="no-referrer" onerror="this.src=\''+FI+'\'" />'+
                    '<div class="truncate flex-1 min-w-0"><h3 class="font-bold text-xs sm:text-sm truncate '+(isCur?'text-white font-black':'text-white/90')+'">'+es(t.title)+'</h3><p class="text-[#a0a5b0] text-[11px] truncate mt-0.5">'+es(t.artist)+'</p></div>'+
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left relative z-10">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mt-3.5 justify-center sm:justify-start">
                            <a href="https://whatsapp.com/channel/0029Vb8cslf8aKvEpFOaMC0m" target="_blank" class="btn-chrome px-3.5 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-md active:scale-95 transition-all">
                                💬 Channel WA
                            </a>
